...
#ifndef FYRE_TEST_SCRIPTNUM10_H
#define FYRE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fyre Core 0.10.0, for cross-comparison.
 */
public:
