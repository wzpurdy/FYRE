...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CFyreAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CFyreAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CFyreAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CFyreAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CFyreAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFyreAddress(arr[0].get_str()).Get() == demoAddress.Get());
