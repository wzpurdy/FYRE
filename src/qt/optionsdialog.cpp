    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FYRE-light"), QVariant("light"));
    ui->theme->addItem(QString("FYRE-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("FYRE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FYRE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FYRE-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new FyreUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->fyreAtStartup, OptionsModel::StartAtStartup);
