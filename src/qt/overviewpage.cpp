...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(FyreUnits::FYR),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = FyreUnits::floorWithUnit(unit, amount, true, FyreUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, FyreUnits::separatorAlways));
    ui->labelUnconfirmed->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, FyreUnits::separatorAlways));
    ui->labelImmature->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, FyreUnits::separatorAlways));
    ui->labelAnonymized->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, FyreUnits::separatorAlways));
    ui->labelTotal->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, FyreUnits::separatorAlways));
    ui->labelWatchAvailable->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, FyreUnits::separatorAlways));
    ui->labelWatchPending->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, FyreUnits::separatorAlways));
    ui->labelWatchImmature->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, FyreUnits::separatorAlways));
    ui->labelWatchTotal->setText(FyreUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, FyreUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("FYR")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = FyreUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, FyreUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), FyreUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = FyreUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, FyreUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), FyreUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(FyreUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(FyreUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
