...
#include "config/fyre-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFyreURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FyreUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFyreURI(info));
}
