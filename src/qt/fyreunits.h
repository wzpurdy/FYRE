...
#ifndef FYRE_QT_FYREUNITS_H
#define FYRE_QT_FYREUNITS_H
...
/** Fyre unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FyreUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FyreUnits(QObject *parent);

    /** Fyre units.
      @note Source: https://en.fyre.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FYR,
...
typedef FyreUnits::Unit FyreUnit;

#endif // FYRE_QT_FYREUNITS_H
