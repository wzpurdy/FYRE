...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FyreNetwork") type = FyreNetwork;
    if(strType == "FyreNetworkVariable") type = FyreNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FyreNetwork) s = "FyreNetwork";
    if(type == FyreNetworkVariable) s = "FyreNetworkVariable";
