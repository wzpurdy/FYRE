 ...
 *
 *   // network
 *   CFyreNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.fyre.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFyreNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FyreNetwork
// //   -- signature requirements : Key1(User)
// class CFyreNetworkVariable : public CGovernanceObject
// {
// private:
