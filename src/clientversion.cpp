 ...
 * for both fyred and fyre-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Fyre Core");
...
#ifdef GIT_ARCHIVE
#define GIT_COMMIT_ID "c48e78d"
#define GIT_COMMIT_DATE "Sun, 17 Feb 2019 07:19:21 +0800"
#endif
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/fyre/bips/blob/master/bip-0014.mediawiki) 
 */
