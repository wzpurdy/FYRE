...
unlocked to sign the Fyre-Qt.app bundle.
...
allowing somebody to distribute a Fyre-Qt.app or fyre-qt-setup.exe with a valid
...
that the fyre-qt.exe file inside the installer had not been tampered with.
