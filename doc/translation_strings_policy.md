...
This document provides guidelines for internationalization of the Fyre Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fyre_en.ts` remains unchanged.
