...
This mechanism has been integrated into Bitcore-Node-Fyre which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fyrecrypto/insight-api-fyre#web-socket-api](https://github.com/fyrecrypto/insight-api-fyre#web-socket-api)
* API: [https://github.com/fyrecrypto/insight-api-fyre#instantsend-transactions](https://github.com/fyrecrypto/insight-api-fyre#instantsend-transactions)
...
By default, the Fyre Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fyre Core daemon:
