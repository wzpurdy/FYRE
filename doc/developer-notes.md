...
Fyre Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- FyreMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as Fyre Core, where everyone uses
...
pay attention to for reviewers of Fyre Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Fyre Core uses tinyformat, which is type safe. Leave them out to avoid confusion
